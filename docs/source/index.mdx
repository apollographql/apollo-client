...
The docs for Apollo Client are mainly written using the [React integration](/v2.5/essentials/get-started/), but most of the examples work no matter where you use Apollo. The docs are broken into five distinct sections to make it easy to find your way around:
...
- JavaScript
  ...
  - [Vue](/v2.5/integrations/#vue)
  - [Meteor](/v2.5/recipes/meteor/)
  - [Ember](/v2.5/integrations/#ember)
- Web Components
  - [Apollo Elements](/v2.5/integrations/#web-components)
- Native mobile

...
export interface MutationOptions {
  ...
  /**
   * A boolean preventing the store from being updated with the mutation response.
   * The main reason for preventing the store from being updated is to avoid
   * potential performance problems associated with this. In this case you would
   * most likely want to use updateQueries with the updateStoreFlag set to false.
   */

...
> All code samples below assume that you have initialized an instance of `ApolloClient` from `@apollo/client/react` and that you have imported the `gql` function from `@apollo/client`. If you haven't, [get started](../get-started).
>

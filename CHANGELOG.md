...
- Query and Mutation result actions now store query/mutation store values to simplify data reducer. [Issue #370](https://github.com/apollostack/apollo-client/issues/370) and [PR #417](https://github.com/apollostack/apollo-client/pull/417)

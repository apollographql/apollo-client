...
import { Loading, Header, LaunchDetail } from "../components.js";
import { ActionButton } from "../containers.js";
...
```js
import { GET_CART_ITEMS } from './pages/cart.js';
...
export const Stats = Loadable({
  loader: () => import('./components/stats/Stats.js'),
  loading: Loading,
});
```

...
These error classes are designed to give you precise information about what went wrong, whether it's a server-side GraphQL error, a network connectivity issue, etc.

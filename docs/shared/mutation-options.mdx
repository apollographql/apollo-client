...
Unlike queries, mutations do not support alternate [fetch policies](https://www.apollographql.com/docs/react/data/queries/#setting-a-fetch-policy) besides `no-cache`.

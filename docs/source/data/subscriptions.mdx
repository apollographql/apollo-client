...
> A word of warning: As of Nov 4 2020 the `subscriptions-transport-ws` library is not being actively maintained anymore. It is recommended that you use the [graphql-ws](https://github.com/enisdenjo/graphql-ws) library instead. For details read the [GraphQL over WebSockets](https://the-guild.dev/blog/graphql-over-websockets) announcement. A good documentation can be found at [README](https://github.com/enisdenjo/graphql-ws#readme)

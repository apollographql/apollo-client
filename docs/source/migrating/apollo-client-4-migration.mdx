...
All links are now available as classes. The old link creator functions are still provided, but are now are deprecated and will be removed in a future major version.

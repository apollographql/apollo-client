...
| Name    | Description                                                                                                                                                                                                                                                                          |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `link`  | Apollo Client uses an Apollo Link instance to serve as its network layer. The vast majority of clients use HTTP and should provide an instance of `HttpLink` from the `apollo-link-http` package. <br/><br/> For more information, see the [Apollo Link documentation](/docs/link/). |

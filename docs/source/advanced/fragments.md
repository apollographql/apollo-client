...
Will make the contents of `someFragment.graphql` available to the current file. See the [Webpack Fragments](/v2.4/recipes/webpack/#fragments) section for additional details.

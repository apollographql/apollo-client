...
- [Apollo Client API](../api/apollo-client.html): Sometimes, you'll need to access the client directly like we did in our plain JavaScript example above. To learn more about the Apollo Client visit the API reference for a full list of options.

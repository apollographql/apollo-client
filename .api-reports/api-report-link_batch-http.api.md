...
// @public (undocumented)
type BatchHandler = (operations: Operation[], forward?: (NextLink | undefined)[]) => Observable<FetchResult[]> | null;

// @public (undocumented)
export namespace BatchHttpLink {
    // Warning: (ae-forgotten-export) The symbol "BatchLink" needs to be exported by the entry point index.d.ts

...
import {CodeBlockContext, MultiCodeBlock} from 'gatsby-theme-apollo-docs';
...
<CodeBlockContext.Provider value={{filename: 'Dogs.js'}}>
<MultiCodeBlock>
...
<CodeBlockContext.Provider value={{filename: 'DogPhoto.js'}}>
...
<CodeBlockContext.Provider value={{filename: 'DelayedQuery.js'}}>

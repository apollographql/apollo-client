...
2. **Caching:** Learn how to [configure](/caching/cache-configuration/) and [interact with](/caching/cache-interaction/) the cache.
...
6. **Networking:** Learn about [Apollo Link](/networking/network-layer/), Apollo's network interface layer, and implementing [authentication](/networking/authentication/).

...
api_doc:
  - "@apollo/client!ApolloClient#watchFragment:member(1)"
---

import { DocBlock } from '../../shared/ApiDoc';
...
<DocBlock canonicalReference={"@apollo/client!ApolloClient#watchFragment:member(1)"} />

...
This will only be able to provide access to your client if there is an [`<ApolloProvider/>`](./hooks/#apolloprovider) component higher up in your tree to actually provide the client.

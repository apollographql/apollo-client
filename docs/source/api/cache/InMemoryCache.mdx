...
For usage instructions, see [Interacting with cached data: `cache.batch`](../../caching/cache-interaction/#using-cachebatch).
...
<PropertySignatureTable
  canonicalReference="@apollo/client/cache!Cache.BatchOptions:interface"

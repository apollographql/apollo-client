...
<Caution>
  ...
  removed in [Apollo Client v4](https://community.apollographql.com/t/apollo-client-v4-alpha-releases-are-here/8719) in June 2025. Please use [GraphQL
  Testing Library](https://github.com/apollographql/graphql-testing-library)
  instead.
</Caution>

...
### `DocumentTransform` constructor

<TypeScriptApiBox name="DocumentTransform.constructor" />
...
<TypeScriptApiBox name="DocumentTransform.concat" />
<TypeScriptApiBox name="DocumentTransform.split" />
<TypeScriptApiBox name="DocumentTransform.transformDocument" />

...
Replace the value of the `uri` option with your GraphQL server's subscription-specific WebSocket endpoint. If you're using Apollo Server, see [Enabling subscriptions](/apollo-server/data/subscriptions/#enabling-subscriptions).

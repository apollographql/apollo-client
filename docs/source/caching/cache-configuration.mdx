...
<td>
Include this configuration option to customize the max size of the cache. It can reduce the potential max memory impact while retaining the performance benefit of resultCaching.

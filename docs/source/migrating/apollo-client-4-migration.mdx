...
```ts disableCopy=true
import { FetchResult } from "@apollo/client"; // [!code --:2]
fn<FetchResult>();
import { ApolloLink } from "@apollo/client"; // [!code ++:2]
...
```ts disableCopy=true
import { createHttpLink } from "@apollo/client"; // [!code --:2]
const link = createHttpLink({ uri: "https://example.com/graphql" });
import { HttpLink } from "@apollo/client/link/http"; // [!code ++:2]
...
```ts disableCopy=true
import { from } from "@apollo/client"; // [!code --:2]

...
<PropertySignatureTable canonicalReference="@apollo/client!QueryHookOptions:interface" />
...
<PropertySignatureTable canonicalReference="@apollo/client!QueryResult:interface" />

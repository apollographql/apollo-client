...
> For a more complete introduction to the entire Apollo platform, [check out **Odyssey**, Apollo's new learning platform](https://odyssey.apollographql.com?utm_source=apollo_docs&utm_medium=referral). You can also complete the [full-stack quickstart](https://www.apollographql.com/tutorials/fullstack-quickstart/introduction).

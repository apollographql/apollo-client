...
describe("useQuery Hook", () => {
  ...
  describe("Error handling", () => {
    ...
    it('calls `onError` when returning partial data with GraphQL errors while using an `errorPolicy` set to "all"', async () => {
      const query = gql`
        {
          hello
        }
    ...
    it("should persist errors on re-render with inline onError callbacks", async () => {
      const query = gql`
        {
          hello
        }

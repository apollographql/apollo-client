...
queryResult.data; // Actual runtime type: TData | undefined
```
...
If you can't declare a single global default (for example, if you have multiple Apollo Client instances with different default options), you can opt out by declaring those options as optional union types covering all values you use:

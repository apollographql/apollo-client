...
To determine the ID of the entity, we pass the `__typename` and primary key fields of the object to the `cache.identify` method. The `cache.modify` method is used to update specific fields within a given entity object.
...
```ts title="codegen.ts"import type { CodegenConfig } from "@graphql-codegen/cli";
...
```js
import { ApolloClient, InMemoryCache, LocalState, HttpLink, gql } from '@apollo/client';
...
<FunctionDetails canonicalReference="@apollo/client!ApolloCache#writeQuery:member(1)" headingLevel={5}  parameters={false} result={false}/>
<FunctionDetails canonicalReference="@apollo/client!ApolloCache#readQuery:member(1)" headingLevel={5}  parameters={false} result={false}/>
<FunctionDetails canonicalReference="@apollo/client!ApolloCache#writeFragment:member(1)" headingLevel={5}  parameters={false} result={false}/>
<FunctionDetails canonicalReference="@apollo/client!ApolloCache#readFragment:member(1)" headingLevel={5}  parameters={false} result={false}/>

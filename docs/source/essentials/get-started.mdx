...
| `clientState`    | { resolvers?: Object, defaults?: Object, typeDefs?: string \| Array &lt;string&gt; }                                         | An object representing your local state configuration. This is useful if you would like to use the Apollo cache for [local state management](./local-state/).                                                                                                                                                                           |
...
- [Queries](./queries/): Learn how to fetch queries with arguments and dive deeper into configuration options. For a full list of options, check out the API reference for `useQuery`.
- [Mutations](./mutations/): Learn how to update data with mutations and when you'll need to update the Apollo cache. For a full list of options, check out the API reference for `useMutation` components.

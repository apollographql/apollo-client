...
This can be useful in cases where an Apollo Client API is wrapped by your own custom handling, which might throw its own errors, and you want to retry an operation at the call site when the error originates from the link chain.

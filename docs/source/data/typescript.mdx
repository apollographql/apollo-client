...
If you can't declare specific global defaults (for example, if you have multiple Apollo Client instances with different default options), you can opt out by declaring options as `unknown`:

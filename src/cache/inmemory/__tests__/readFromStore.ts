...
describe("reading from the store", () => {
  ...
  it("returns === results for different queries", function () {
    ...
    expect(aResult1.a).toEqual(abResult1.a);
    expect(aResult1.a).not.toBe(abResult1.a);
    ...
    expect(abResult1.b).not.toBe(bResult1.b);
    ...
    expect(aResult2.a).not.toBe(abResult2.a);
    expect(bResult2).toBe(bResult1);
    expect(abResult2.b).toEqual(bResult2.b);
    expect(abResult2.b).not.toBe(bResult2.b);
    expect(abResult2.b).toEqual(bResult1.b);
    expect(abResult2.b).not.toBe(bResult1.b);

...
The `graphql()` function will only be able to provide access to your GraphQL data if there is a [`<ApolloProvider/>`](/v2.6/api/react-common/#apolloprovider) component higher up in your tree to provide an [`ApolloClient`](/v2.6/api/apollo-client/) instance that will be used to fetch your data.
...
A simple enhancer which provides direct access to your [`ApolloClient`](/v2.6/api/apollo-client/) instance. This is useful if you want to do custom logic with Apollo. Such as calling one-off queries. By calling this function with the component you want to enhance, `withApollo()` will create a new component which passes in an instance of `ApolloClient` as a `client` prop.
...
This will only be able to provide access to your client if there is an [`<ApolloProvider/>`](/v2.6/api/react-common/#apolloprovider) component higher up in your tree to actually provide the client.

...
> A [GraphQL fragment](http://graphql.org/learn/queries/#fragments) defines a subselection of fields on a GraphQL type, that can help define component-level data dependencies or allow re-use between multiple queries and mutations. [See the API reference.](../../data/fragments)

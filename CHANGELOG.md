...
### vNext
- **new Feature**: In network interface, enable chaining the `use` and `useAfter` functions, respectively. [Issue #564](https://github.com/apollostack/apollo-client/issues/564)

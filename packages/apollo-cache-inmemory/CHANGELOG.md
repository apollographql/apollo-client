...
- Don't broadcast query watchers during a transaction (for example, while mutation results are being processed) [PR #2358](https://github.com/apollographql/apollo-client/pull/2358)

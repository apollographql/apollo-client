...
The `readQuery` method is very similar to the [`query` method on `ApolloClient`](/v2.6/api/apollo-client/#ApolloClient.query) except that `readQuery` will _never_ make a request to your GraphQL server. The `query` method, on the other hand, may send a request to your server if the appropriate data is not in your cache whereas `readQuery` will throw an error if the data is not in your cache. `readQuery` will _always_ read from the cache. You can use `readQuery` by giving it a GraphQL query like so:
...
- [`ApolloClient#query` API documentation](/v2.6/api/apollo-client/#ApolloClient.query)
- [`ApolloClient#readQuery` API documentation](/v2.6/api/apollo-client/#ApolloClient.readQuery)
...
- [`ApolloClient#readFragment` API documentation](/v2.6/api/apollo-client/#ApolloClient.readFragment)
...
- [`ApolloClient#watchQuery` API documentation](/v2.6/api/apollo-client/#ApolloClient.watchQuery)
- [`ApolloClient#writeQuery` API documentation](/v2.6/api/apollo-client/#ApolloClient.writeQuery)
- [`ApolloClient#writeFragment` API documentation](/v2.6/api/apollo-client/#ApolloClient.writeFragment)
- [`DataProxy#writeQuery` API documentation](/v2.6/api/apollo-client/#ApolloClient.writeQuery)
- [`DataProxy#writeFragment` API documentation](/v2.6/api/apollo-client/#ApolloClient.writeFragment)
...
- [`ApolloClient#mutate` API documentation](/v2.6/api/apollo-client/#ApolloClient.mutate)

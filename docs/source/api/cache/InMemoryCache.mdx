...
The update function takes a cached query's current value and returns the value that should replace it, or `undefined` if no change should be made.
...
The update function takes a cached fragment's current value and returns the value that should replace it, or `undefined` if no change should be made.

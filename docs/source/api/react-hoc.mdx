...
The `graphql()` function will only be able to provide access to your GraphQL data if there is a [`<ApolloProvider/>`](react-hooks/#apolloprovider) component higher up in your tree to provide an [`ApolloClient`](core/) instance that will be used to fetch your data.
...
This will only be able to provide access to your client if there is an [`<ApolloProvider/>`](react-hooks/#apolloprovider) component higher up in your tree to actually provide the client.

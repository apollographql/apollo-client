...
interface Meta {
    ...
    // (undocumented)
    readonly variables: OperationVariables_2 | undefined;
}
...
class QueryManager {
    ...
    //
    // (undocumented)
    fetchObservableWithInfo<TData, TVars extends OperationVariables_2>(queryInfo: QueryInfo, options: WatchQueryOptions_2<TVars, TData>, networkStatus?: NetworkStatus, query?: DocumentNode | TypedDocumentNode<TData, TVars>, fetchQueryMiddleware?: (forward: () => ObservableAndInfo<TData>) => ObservableAndInfo<TData>): ObservableAndInfo<TData>;
    // (undocumented)
...
// src/core/ObservableQuery.ts:130:5 - (ae-forgotten-export) The symbol "RefetchWritePolicy" needs to be exported by the entry point index.d.ts
...
// src/core/types.ts:210:3 - (ae-forgotten-export) The symbol "MutationQueryReducer" needs to be exported by the entry point index.d.ts
// src/core/types.ts:238:5 - (ae-forgotten-export) The symbol "Resolver" needs to be exported by the entry point index.d.ts

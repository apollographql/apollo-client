...
## SSR
There are two additional configurations that you need to keep in mind when using [React Server Side Rendering](/v2.4/features/server-side-rendering/) with Meteor.

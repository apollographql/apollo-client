...
| `refetchQueries`| (mutationResult: FetchResult) => Array&lt;{ query: DocumentNode, variables?: TVariables}&gt; | A function that allows you to specify which queries you want to refetch after a mutation has occurred, or an array of strings that does ???? |

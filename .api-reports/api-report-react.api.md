...
//
// src/core/LocalState.ts - (ae-forgotten-export) The symbol "ApolloClient_2" needs to be exported by the entry point index.d.ts
...
// src/core/types.ts - (ae-forgotten-export) The symbol "MutationQueryReducer" needs to be exported by the entry point index.d.ts
// src/core/types.ts - (ae-forgotten-export) The symbol "Resolver" needs to be exported by the entry point index.d.ts
// src/core/watchQueryOptions.ts - (ae-forgotten-export) The symbol "UpdateQueryOptions" needs to be exported by the entry point index.d.ts
// src/react/hooks/useLoadableQuery.ts - (ae-forgotten-export) The symbol "ResetFunction" needs to be exported by the entry point index.d.ts
// src/react/hooks/useSuspenseFragment.ts - (ae-forgotten-export) The symbol "From" needs to be exported by the entry point index.d.ts

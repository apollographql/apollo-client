...
> **Important:** To use `@client` fields or local resolvers, you must configure your `ApolloClient` with a `LocalState` instance. See the [local resolvers documentation](./local-resolvers/) for setup instructions.

...
Need help with Apollo Client? The Apollo Client AI skill can assist you with questions about setup, configuration, troubleshooting, and best practices. Install it with:

```bash
npx skills add apollographql/skills --skill apollo-client
```

The AI skill provides contextual help tailored to Apollo Client 4.x, including guidance on hooks, caching strategies, and React integration patterns.

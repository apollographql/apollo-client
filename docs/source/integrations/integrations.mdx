...
State management abstractions built on top of Apollo Client for React and Angular.  The [Orbit for Apollo Client](https://wassim-k.github.io/apollo-orbit/) project was created by and is maintained by [@wassim-k](https://github.com/wassim-k).

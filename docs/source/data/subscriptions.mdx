...
<PropertySignatureTable canonicalReference="@apollo/client!SubscriptionHookOptions:interface" />

### Result

After being called, the `useSubscription` Hook returns a result object with the following properties:

<PropertySignatureTable canonicalReference="@apollo/client!SubscriptionResult:interface" />

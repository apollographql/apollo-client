...
State management abstractions built on top of Apollo Client for React and Angular.  The [Apollo Orbit](https://wassim-k.github.io/apollo-orbit/) project was created by and is maintained by [@wassim-k](https://github.com/wassim-k).

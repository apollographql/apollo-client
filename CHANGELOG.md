...
- Fix issue where starting, stopping, then starting a polling query with the same interval wasn't handled correctly by the scheduler. [PR #555](https://github.com/apollostack/apollo-client/pull/555) and [PR #XXX](https://github.com/apollostack/apollo-client/pull/XXX).

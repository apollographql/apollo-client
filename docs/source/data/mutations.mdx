...
<PropertySignatureTable canonicalReference="@apollo/client!useMutation.Options:interface" idPrefix="mutationhookoptions-interface" />
...
<PropertySignatureTable canonicalReference="@apollo/client!useMutation.Result:interface" idPrefix="mutationresult-interface" />

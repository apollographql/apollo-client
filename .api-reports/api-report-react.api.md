...
class QueryManager {
    ...
    // (undocumented)
    watchQuery<T, TVariables extends OperationVariables_2 = OperationVariables_2>(options: ApolloClient_2.WatchQueryOptions<T, TVariables>): ObservableQuery<T, TVariables>;
}

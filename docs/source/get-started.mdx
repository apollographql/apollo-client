...
| `clientState`    | { resolvers?: Object, defaults?: Object, typeDefs?: string \| Array &lt;string&gt; }                                         | An object representing your local state configuration. This is useful if you would like to use the Apollo cache for [local state management](/local-data/local-state/).                                                                                                                                                                           |

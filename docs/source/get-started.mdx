...
> If you are using a React sandbox from CodeSandbox and running into issues, try downgrading your `graphql` package. You can use `npm install graphql@15.8.0` to downgrade.

Our example application will use the [FlyBy GraphQL API](https://flyby-gateway.herokuapp.com/) from the [Voyage tutorial series](https://www.apollographql.com/tutorials/voyage-part1/) in Apollo Odyssey. This API provides a list of intergalactic travel locations and details about those locations 👽
...
When your app reloads, you should briefly see a loading indicator, followed by a list of locations and details about those locations! If you don't, you can compare your code against the [completed app on CodeSandbox](https://codesandbox.io/s/get-started-apollo-client-demo-bert8s).

...
Note the use of the 'name' option on the grapql() call to name the prop that will receive the mutation function for each mutation (by defaut that name is 'mutate').

...
For usage instructions, refer to [Interacting with cached data: Identify cached entities](../../caching/cache-interaction/#identify-cached-entities).
...
For usage instructions, refer to [Interacting with cached data: Modifying fields](../../caching/cache-interaction/#modifying-fields).
...
For usage instructions, refer to [Interacting with cached data: gc](../../caching/cache-interaction/#gc).
...
For usage instructions, refer to [Interacting with cached data: evict](../../caching/cache-interaction/#evict).

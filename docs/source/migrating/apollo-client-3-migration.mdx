...
To illustrate the migration process, we've also made this video that uses the example app from our [full-stack tutorial](/tutorial/introduction/) as a starting point, updating it from Apollo client 2.6 to 3.0:

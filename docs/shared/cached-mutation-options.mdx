...
| `cacheId` | string | The id of the item into the cache. You can more about it [here](../source/api/cache/InMemoryCache#input) |
| `updateKey` | string | The key of the item into the cache that should be updated |

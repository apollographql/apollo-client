...
- `defaultOptions`: An object containing options to pass directly to the `ApolloClient`instance. See documentation [here](/api/apollo-client/#apolloclient).

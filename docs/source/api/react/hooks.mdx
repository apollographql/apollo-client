...
<FunctionDetails canonicalReference="@apollo/client!useQuery:function(1)" headingLevel={2} parameters={false} result={false} />
...
| `options` | `useQuery.Options \| skipToken` | An optional object containing options for the query. |

Instead of passing a `useQuery.Options` object into the hook, you can also pass a [`skipToken`](#skiptoken) to prevent the `useQuery` hook from executing the query.

<InterfaceDetails
  canonicalReference="@apollo/client!useSuspenseQuery.DocumentationTypes.useSuspenseQuery.Options:interface"
  customPropertyOrder={["variables", "errorPolicy", "skip"]}
  headingLevel={3}
/>

<InterfaceDetails
  canonicalReference="@apollo/client!useSuspenseQuery.DocumentationTypes.useSuspenseQuery.Result:interface"
  headingLevel={3}
/>
...
<FunctionDetails
  canonicalReference="@apollo/client!useFragment.DocumentationTypes.useFragment:function(1)"
  headingLevel={2}
  parameters={false}
  result={false}
/>
...
<InterfaceDetails
  canonicalReference="@apollo/client!useFragment.Options:interface"
  headingLevel={3}
/>

<InterfaceDetails
  canonicalReference="@apollo/client!useFragment.DocumentationTypes.useFragment.Result:interface"
  headingLevel={3}
/>
...
| ------- | ------------ | ------------------------------------------------------------- |
| `query` | `(Typed)DocumentNode` | A GraphQL query document parsed into an AST by `gql`. |
| `options` | `useSuspenseQuery.Options \| skipToken` | An optional object containing options for the query. |
...
| ------- | ------------ | ------------------------------------------------------------- |
| `query` | `(Typed)DocumentNode` | A GraphQL query document parsed into an AST by `gql`. |
| `options` | `useBackgroundQuery.Options \| skipToken` | An optional object containing options for the query. |

Instead of passing a `useBackgroundQuery.Options` object into the hook, you can also pass a [`skipToken`](#skiptoken) to prevent the `useBackgroundQuery` hook from executing the query or suspending.



<InterfaceDetails
  canonicalReference="@apollo/client!useBackgroundQuery.DocumentationTypes.useBackgroundQuery.Options:interface"
  headingLevel={3}
/>
...
<InterfaceDetails
  canonicalReference="@apollo/client!useReadQuery.DocumentationTypes.useReadQuery.Result:interface"
  headingLevel={3}
/>

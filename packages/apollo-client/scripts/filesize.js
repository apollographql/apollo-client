...
console.log(
  `The total size of ${Path.basename(filePath)} is ${Colors.green(totalSize)}.`,
);
console.log(
  `The total gzipped size of ${Path.basename(filePath)} is ${Colors.green(
    totalGzippedSize,
  )}.`,
);
console.log(
...
if (Flags.max) {
  ...
  if (max > totalSize) {
    ...
    console.log(
      Colors.red(
        `The total size of ${Path.basename(filePath)} exceeds ${PrettyBytes(
          max,
        )}.`,
      ),
    );
...
if (Flags.maxGzip) {
  ...
  if (rawGzippedSize > maxGzip) {
    ...
    console.log(
      Colors.red(
        `The total gzipped size of ${Path.basename(
          filePath,
        )} exceeds ${PrettyBytes(maxGzip)}.`,
      ),
    );
  }
}

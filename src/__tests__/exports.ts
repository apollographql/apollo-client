...
import * as linkLocalResolvers from "@apollo/client/link/local-resolvers";
import * as linkLocalResolversCodegen from "@apollo/client/link/local-resolvers/codegen";
...
describe("exports of public entry points", () => {
  ...
  check("@apollo/client/link/local-resolvers", linkLocalResolvers);
  check(
    "@apollo/client/link/local-resolvers/codegen",
    linkLocalResolversCodegen
  );

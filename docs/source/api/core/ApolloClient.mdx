...
TODO: remove example usages
<DocBlock canonicalReference="@apollo/client!ApolloClient:constructor(1)" />
<DocBlock canonicalReference="@apollo/client!ApolloClient#readQuery:member(1)" />
...
The default value is `false` in production builds and `true` in development builds.
</td>
</tr>
